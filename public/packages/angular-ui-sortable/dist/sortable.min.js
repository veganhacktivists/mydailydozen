      ...
      function(a, d, e) {
        return {
          ...
          link: function(f, g, h, i) {
              ...
              return (
                E[b]
                  ? ('stop' === b &&
                    ...
                    (c = j(E[b], c)))
                  : F[b] && (c = F[b](c)),
                c || ('items' !== b && 'ui-model-items' !== b) || (c = a.items),
                c
              )
            }
            function o(a, d, e) {
              ...
              if (d) {
                ...
                b.forEach(d, function(d, e) {
                  if (!(a && e in a)) {
                    if (e in D)
                      return void ('ui-floating' === e
                        ? (C[e] = 'auto')
                        : (C[e] = n(e, c)))
                    h || (h = b.element.ui.sortable().options)
                    var f = h[e]
                    ;(f = n(e, f)), g || (g = {}), (g[e] = f), (C[e] = f)
                  }
                })
              }
              return (
                  ...
                  if (c in D) {
                    if (
                      ('ui-floating' !== c ||
                        ...
                        !e ||
                        (e.floating = b),
                      'ui-preserve-size' === c && (b === !1 || b === !0))
                    ) {
                      var d = C.helper
                      a.helper = function(a, b) {
                        return (
                          C['ui-preserve-size'] === !0 && l(b),
            ...
            function q(a, b) {
              var c = C['ui-model-items'].replace(/[^,]*>/g, ''),
            ...
            function r(a, b) {
              ...
              return (
                'clone' === c ||
                ('function' == typeof c && b.item.sortable.isCustomHelperUsed())
              )
            }
            function s(a, b) {
              var c = null
              return (
                r(a, b) &&
                  'parent' === a.sortable('option', 'appendTo') &&
                  (c = B),
                c
              )
            }
              ...
              f.$watchCollection('ngModel', function() {
                ...
                (E.start = function(a, d) {
                  ...
                  d.item.sortable = {
                    ...
                    _getElementContext: function(a) {
                      return u(this._connectedSortables, a)
                    },
                  }
                }),
                (E.activate = function(a, b) {
                  var c = b.item.sortable.source === g,
                    d = c ? b.item.sortable.sourceList : g,
                    e = {
                      element: g,
                      scope: f,
                      isSourceContext: c,
                  ...
                  b.item.sortable._connectedSortables.push(e),
                    (A = d.contents()),
                    (B = b.helper)
                  var h = p(g)
                  if (h && h.length) {
                ...
                (E.update = function(a, b) {
                  if (!b.item.sortable.received) {
                    b.item.sortable.dropindex = w(b.item)
                    var c = b.item
                      .parent()
                      .closest(
                    ...
                    ;(b.item.sortable.droptarget = c),
                      (b.item.sortable.droptargetList = b.item.parent())
                    var d = b.item.sortable._getElementContext(c)
                    ;(b.item.sortable.droptargetModel = d.scope.ngModel),
                      g.sortable('cancel')
                  }
                  var e = !b.item.sortable.received && s(g, b, A)
                  e && e.length && (A = A.not(e))
                  var h = b.item.sortable._getElementContext(g)
                  A.appendTo(h.savedNodesOrigin),
                    b.item.sortable.received && (A = null),
                    b.item.sortable.received &&
                      !b.item.sortable.isCanceled() &&
                      (f.$apply(function() {
                        i.$modelValue.splice(
                          b.item.sortable.dropindex,
                          0,
                          b.item.sortable.moved,
                        )
                      }),
                      f.$emit('ui-sortable:moved', b))
                }),
                (E.stop = function(a, c) {
                  var d =
                    'dropindex' in c.item.sortable &&
                    !c.item.sortable.isCanceled()
                  if (d && !c.item.sortable.received)
                    f.$apply(function() {
                      i.$modelValue.splice(
                        c.item.sortable.dropindex,
                        0,
                        i.$modelValue.splice(c.item.sortable.index, 1)[0],
                      )
                    }),
                      f.$emit('ui-sortable:moved', c)
                  else if (
                    !d &&
                    !b.equals(g.contents().toArray(), A.toArray())
                  ) {
                    var e = s(g, c, A)
                    e && e.length && (A = A.not(e))
                ...
                (E.receive = function(a, b) {
                  b.item.sortable.received = !0
                }),
                (E.remove = function(a, b) {
                  'dropindex' in b.item.sortable ||
                    (g.sortable('cancel'), b.item.sortable.cancel()),
                    b.item.sortable.isCanceled() ||
                      f.$apply(function() {
                        b.item.sortable.moved = i.$modelValue.splice(
                          b.item.sortable.index,
                          1,
                        )[0]
                      })
                }),
                ...
                (F.helper = function(a) {
                  return a && 'function' == typeof a
                    ? function(d, e) {
                        ...
                        return (
                          e.sortable._restore(),
                          (e.sortable._isCustomHelperUsed = e !== j),
                          j
                        )
                      }
                    : a
            ...
            function y() {
              i ? x() : e.info('ui.sortable: ngModel not provided!', g),
                g.sortable(C)
            }
            function z() {
              return f.uiSortable && f.uiSortable.disabled
                ? !1
                : (y(), z.cancelWatcher(), (z.cancelWatcher = b.noop), !0)
            }
            var A,
              B,
              C = {},
              ...
              F = { helper: null }
            return (
              b.extend(C, D, a, f.uiSortable),
              b.element.fn && b.element.fn.jquery
                ? ((z.cancelWatcher = b.noop),
                  void (
                    z() ||
                    (z.cancelWatcher = f.$watch('uiSortable.disabled', z))
                  ))
                : void e.error(
