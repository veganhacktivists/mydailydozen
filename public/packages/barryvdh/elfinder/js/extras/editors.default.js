  ...
  var apps = {},
    ...
    pixlrLoad = function(mode, base) {
      if (navigator && !navigator.mimeTypes['application/x-shockwave-flash']) {
        var src =
          'data:application/x-shockwave-flash;base64,'
        $(base)
          .empty()
          .append(
            '<object data="' +
              src +
              '" type="application/x-shockwave-flash" style="width:100%;height:100%"><param name="movie" value="' +
              src +
              '"></object>',
          )
        return
        ...
        var self = this,
          ...
          init = function(editor) {
            ...
            $base
              ...
              .on('click', '.tui-colorpicker-palette-preview', function() {
                $(this)
              ...
              .then(function(editor) {
                ...
                if (
                  ...
                  $(editnode)
                    ...
                    .append(
                      $(editor.ui.view.toolbar.element).css({
                        marginRight: '-1em',
                        marginLeft: '-1em',
                      }),
                    )
    ...
    },
    {
      ...
      init: function(id, file, dum, fm) {
        var ta = this,
          ...
          select = $(this).append(btns, set.showLink ? $(set.link) : null),
          spnr = $(
          ...
          prog = $('<div class="elfinder-quicklook-info-progress"/>').appendTo(
            spnr,
          ),
          _url = null,
          url = function() {
            ...
            if (_url) {
              ...
              spnr.show()
              return fm
                .forExternalUrl(file.hash, { progressBar: prog })
                .done(function(url) {
                  _url = url
                })
                .fail(function(error) {
