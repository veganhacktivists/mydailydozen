!(function(r) {
  ...
  var n,
    ...
    v = function(n) {
      return null === n || n === undefined ? E : h(n)
    },
    T =
      ((i = 'function'),
      function(n) {
    ...
    y = {
      ...
      fromPoint: function(n, e, t) {
        var r = n.dom()
        return v(r.elementFromPoint(e, t)).map(O)
      },
    },
    D =
    ...
    x = {
      isMatch: function(n) {
        var e = _(n)
        return C(n) && e !== undefined && k.regExp.test(e)
      },
      filterDescendants: A,
      ...
      replaceWithSpans: function(n) {
        return n.replace(k.regExpGlobal, S)
      },
    },
    P = function(t, n) {
      var r,
        o,
        e = x.filterDescendants(y.fromDom(n), x.isMatch)
      p(e, function(n) {
        var e = x.replaceWithSpans(t.dom.encode(_(n)))
    ...
    R = function(e, n) {
      var t = e.dom.select(k.selector, n)
      p(t, function(n) {
        e.dom.remove(n, 1)
      })
    },
    ...
    U = function(n) {
      var e = n.getBody(),
        ...
        r = x.findParentElm(n.selection.getNode(), e)
      ;(r = r !== undefined ? r : e),
        R(n, r),
        P(n, r),
