;(function() {
  var table = (function(domGlobals) {
    ...
    var clean = function(table, stats) {
      var emptyRows = filter(LayerSelector.firstLayer(table, 'tr'), function(
        row,
      ) {
    ...
    var cloneFormats = function(oldCell, newCell, formats) {
      ...
      return first$1
        .map(function(firstText) {
          ...
          var parents = ancestors$1(firstText, formatSelector, function(
            element,
          ) {
    ...
    var open = function(editor) {
      ...
      if (getCellClassList(editor).length > 0) {
        classListCtrl = {
          ...
          type: 'listbox',
          label: 'Class',
          values: Helpers.buildListItems(getCellClassList(editor), function(
            item,
          ) {
            if (item.value) {
    ...
    var open$1 = function(editor) {
      ...
      if (getRowClassList(editor).length > 0) {
        classListCtrl = {
          ...
          type: 'listbox',
          label: 'Class',
          values: Helpers.buildListItems(getRowClassList(editor), function(
            item,
          ) {
            if (item.value) {
              item.textStyle = function() {
    ...
    var open$2 = function(editor, isProps) {
      ...
      if (getTableClassList(editor).length > 0) {
        ...
        classListCtrl = {
          ...
          type: 'listbox',
          label: 'Class',
          values: Helpers.buildListItems(getTableClassList(editor), function(
            item,
          ) {
            if (item.value) {
              item.textStyle = function() {
