!(function(m) {
  ...
  var t,
    ...
    W = function(e, t) {
      for (var n = 0, r = e.length; n < r; n++) if (t(e[n], n)) return R.some(n)
      return R.none()
    },
    M = function(e) {
    ...
    j = (v(Array.from) && Array.from, Object.keys),
    z = function(e, t) {
    ...
    ne = function(e, t) {
      return (function(e, t) {
        for (
          var n = t !== undefined && null !== t ? t : te, r = 0;
    ...
    He = {
      unknown: function() {
        return ze({ current: undefined, version: Le.unknown() })
      },
      nu: ze,
      edge: C('Edge'),
      chrome: C('Chrome'),
    ...
    Ke = {
      unknown: function() {
        return Xe({ current: undefined, version: Le.unknown() })
      },
      nu: Xe,
      windows: C(Ue),
      ios: C('iOS'),
    ...
    ot = function(e) {
      var t,
        ...
        d = rt.browsers(),
        m = rt.oses(),
        g = $e(d, e).fold(He.unknown, He.nu),
        h = Qe(m, e).fold(Ke.unknown, Ke.nu)
      return {
        browser: g,
        os: h,
        deviceType:
    ...
    lt = function(e) {
      return (
        (e.nodeType !== ut && e.nodeType !== at) || 0 === e.childElementCount
      )
    },
    ft = function(e, t) {
      return e.dom() === t.dom()
    },
    st = it.detect().browser.isIE()
      ? function(e, t) {
    ...
    kt = (q('width', 'height'), q('width', 'height'), q('rows', 'columns')),
    At = q('row', 'column'),
    Pt = (q('x', 'y'), q('element', 'rowspan', 'colspan')),
    It = q('element', 'rowspan', 'colspan', 'isNew'),
    Bt = q('element', 'rowspan', 'colspan', 'row', 'column'),
    Wt = q('element', 'cells', 'section'),
    Mt = q('element', 'isNew'),
    _t = q('element', 'cells', 'section', 'isNew'),
    Lt = q('cells', 'section'),
    Ft = q('details', 'section'),
    jt = q('startRow', 'startCol', 'finishRow', 'finishCol'),
    zt = function(e, t) {
      var n = []
      return (
        k(bt(e), function(e) {
          t(e) && (n = n.concat([e])), (n = n.concat(zt(e, t)))
        }),
        n
      )
    },
  ...
  var Gt,
      ...
      generate: function(e) {
        ...
        k(e, function(e, a) {
          ...
          k(e.cells(), function(e) {
            for (var t = 0; l[sn(a, t)] !== undefined; ) t++
            for (
              var n = Bt(e.element(), e.rowspan(), e.colspan(), a, t), r = 0;
              r < e.colspan();
              r++
            )
    ...
    gn = q('minRow', 'minCol', 'maxRow', 'maxCol'),
    hn = function(e, t) {
      var n,
        i,
        r,
        ...
        h =
          ...
          gn(u, a, c, l)),
        p = 'th:not(' + t + '),td:not(' + t + ')',
        v = tn.filterFirstLayer(e, 'th,td', function(e) {
          return ct(e, p)
        })
      return (
        k(v, Nt),
        ...
        (f.minCol() !== f.maxCol() && f.minRow() !== f.maxRow()) ||
          k(tn.firstLayer(o, 'th,td'), function(e) {
    ...
    pn =
      ...
      (Yt = 'text'),
      {
        get: function(e) {
          if (!Gt(e))
            throw new Error(
              'Can only get ' + Yt + ' value of a ' + Yt + ' node',
            )
          return Xt(e).getOr('')
        },
        ...
        set: function(e, t) {
          if (!Gt(e))
            throw new Error(
              'Can only set raw ' + Yt + ' value of a ' + Yt + ' node',
            )
          e.dom().nodeValue = t
        },
      }),
    ...
    En = function(e, t) {
      var n,
        ...
        o,
        i,
        u = ((n = e), (r = t), (o = xe.fromTag(r)), (i = pe(n)), de(o, i), o),
        a = bt(Nn(e))
      return Dt(u, a), u
    },
    kn = function() {
      var e = xe.fromTag('td')
      return Rt(e, xe.fromTag('br')), e
    },
    An = function(e, t, n) {
      var r = En(e, t)
      return (
      ...
      return {
        ...
        cell: function(e) {
          var r,
            ...
            a,
            c = mt(e.element()),
            l = xe.fromTag(oe(e.element()), c.dom()),
            f = m.getOr([
              'strong',
              'em',
              'b',
                  ...
                  Rn(r)
                    .map(function(e) {
                      ...
                      return P(
                        ...
                        function(e, t) {
                          var n = On(t)
                          return he(n, 'contenteditable'), Rt(e, n), n
                        },
                        o,
                      )
                    })
    ...
    Wn = function(e) {
      return { row: In(e), cell: kn, replace: Pn, gap: kn }
    },
    Mn = function(e, t) {
      return (
        t.column() >= e.startCol() &&
  ...
  function $n() {
    return {
      up: C({ selector: Jt, closest: Zt, predicate: Kt, all: ht }),
      down: C({ selector: qt, predicate: zt }),
      styles: C({ get: Ne, getRaw: ke, set: De, remove: Ae }),
      attrs: C({
        get: me,
        set: se,
        remove: he,
  ...
  var Qn = q('left', 'right'),
    ...
    cr = { create: J(['boxes', 'start', 'finish'], []) },
    lr = function(e) {
      return Jt(e, 'table')
    },
    fr = function(a, c, r) {
      ...
      return ft(a, c)
        ? R.some(cr.create({ boxes: R.some([a]), start: a, finish: c }))
        : lr(a).bind(function(u) {
            return lr(c).bind(function(i) {
              if (ft(u, i))
                return R.some(
                  cr.create({ boxes: Yn(u, a, c), start: a, finish: c }),
                )
              if (st(u, i)) {
                var e =
                  0 < (t = Ht(c, 'td,th', l(u))).length ? t[t.length - 1] : c
                return R.some(
                  cr.create({ boxes: Xn(u, a, u, c, i), start: a, finish: e }),
                )
              }
              if (st(i, u)) {
                var t,
                  n =
                    0 < (t = Ht(a, 'td,th', l(i))).length ? t[t.length - 1] : a
                return R.some(
                  cr.create({ boxes: Xn(i, a, u, c, i), start: a, finish: n }),
                )
              }
              return ar
                .ancestors(a, c)
    ...
    Tr = function(n, e) {
      return Rr.cata(
        ...
        function(t, e) {
          return 0 === t.length
            ? R.none()
            : pr(n, yr.firstSelectedSelector(), yr.lastSelectedSelector()).bind(
                function(e) {
                  return 1 < t.length
    ...
    Dr = function(e, t) {
      ...
      return 0 < n.length &&
        L(n, function(e) {
          return (
            (ge(e, 'rowspan') && 1 < parseInt(me(e, 'rowspan'), 10)) ||
            (ge(e, 'colspan') && 1 < parseInt(me(e, 'colspan'), 10))
          )
        })
        ? R.some(n)
        : R.none()
  ...
  var Ir = Pr('height', function(e) {
    ...
    Fr = it.detect(),
    jr = function(e, t, n) {
      return (r = Ne(e, t)), (o = n), (i = parseFloat(r)), isNaN(i) ? o : i
      var r, o, i
    },
    zr = function(e) {
      return Fr.browser.isIE() || Fr.browser.isEdge()
        ? ((n = jr((t = e), 'padding-top', 0)),
          (r = jr(t, 'padding-bottom', 0)),
          (o = jr(t, 'border-top-width', 0)),
          (i = jr(t, 'border-bottom-width', 0)),
          (u = t.dom().getBoundingClientRect().height),
          'border-box' === Ne(t, 'box-sizing') ? u : u - n - r - (o + i))
        : jr(e, 'height', Br(e))
      var t, n, r, o, i, u
    },
    Hr = /(\d+(\.\d+)?)(\w|%)*/,
    ...
    Yr = function(e) {
      var t,
        n = ke((t = e), 'height').getOrThunk(function() {
          return zr(t) + 'px'
        })
    ...
    $r = {
      ...
      getGenericWidth: function(e) {
        return Kr(e).bind(function(e) {
          var t = Hr.exec(e)
          return null !== t
            ? R.some({ width: C(parseFloat(t[1])), unit: C(t[3]) })
            : R.none()
        })
      },
      ...
      getHeight: function(e) {
        return (n = 'rowspan'), Yr((t = e)) / Xr(t, n)
        var t, n
      },
      getRawWidth: Kr,
    },
    Qr = function(n, r) {
      $r.getGenericWidth(n).each(function(e) {
        var t = e.width() / 2
        $r.setGenericWidth(n, t, e.unit()), $r.setGenericWidth(r, t, e.unit())
      })
    },
    Zr = function(n, r) {
      return {
    ...
    ro = function(e) {
      ...
      return r === n
        ? eo(r.offsetLeft, r.offsetTop)
        : Ce(e)
        ? ((t = n.getBoundingClientRect()), eo(t.left, t.top))
        : eo(0, 0)
    },
    oo = q('row', 'y'),
    io = q('col', 'x'),
  ...
  var bo = function(e) {
    ...
    ko = function(e) {
      0 === (Do(e) ? e.dom().classList : To(e, 'class')).length &&
        he(e, 'class')
    },
    Ao = function(e, t) {
    ...
    Lo = { resolve: _o('ephox-snooker').resolve },
    Fo = function(e, t, n, r, o) {
      ...
      return (
        ...
        de(i, { 'data-column': e, role: 'presentation' }),
        i
      )
    },
    jo = function(e, t, n, r, o) {
      ...
      return (
        ...
        de(i, { 'data-row': e, role: 'presentation' }),
        i
      )
    },
    ...
    di = function(t, e) {
      var n = E(e.selection(), function(e) {
        ...
        r = yo(n)
      return 0 < r.length
        ? R.some({ cells: r, generators: e.generators, clipboard: e.clipboard })
        : R.none()
    },
    mi = function(t, e) {
      var n = E(e.selection(), function(e) {
    ...
    yi = function(e, t, n) {
      ...
      var r = t.slice(e.row()),
        ...
        i = ni.cellLength(n[0]),
        u = n.length
      return pi.value({ rowDelta: C(r.length - u), colDelta: C(o.length - i) })
    },
    xi = function(e, t) {
          ...
          for (
            ...
            for (var h = s; h < m; h++) {
              ;(i = t),
                ...
                1 < i.length &&
                  1 < ni.cellLength(l) &&
                  ((0 < a && c(ni.getCellElement(l, a - 1))) ||
                    (a < l.cells().length - 1 &&
                      c(ni.getCellElement(l, a + 1))) ||
                    (0 < u && c(ni.getCellElement(i[u - 1], a))) ||
                    (u < i.length - 1 && c(ni.getCellElement(i[u + 1], a)))) &&
                  Si(t, ni.getCellElement(t[g], h), o, r.cell)
    ...
    Ni = function(n, r, e, o, i) {
      var t = n.slice(0, r),
        ...
        a = ni.mapCells(n[e], function(e, t) {
          return 0 < r &&
            r < n.length &&
            o(ni.getCellElement(n[r - 1], t), ni.getCellElement(n[r], t))
            ? ni.getCell(n[r], t)
            : Mt(i(e.element(), o), !0)
        })
    ...
    Ei = function(e, n, r, o, i) {
      return E(e, function(e) {
        var t =
          0 < n &&
          n < ni.cellLength(e) &&
          o(ni.getCellElement(e, n - 1), ni.getCellElement(e, n))
            ? ni.getCell(e, n)
            : Mt(i(ni.getCellElement(e, r), o), !0)
    ...
    ki = function(e, r, o, i, u) {
      ...
      return E(e, function(e, t) {
        var n =
          t === r ? Mt(u(ni.getCellElement(e, o), i), !0) : ni.getCell(e, o)
    ...
    Wi = function(e, t, n, r) {
      return (
        ni.getCellElement(e[t], n) !== undefined &&
        0 < t &&
        r(ni.getCellElement(e[t - 1], n), ni.getCellElement(e[t], n))
      )
    },
    Mi = function(e, t, n) {
    ...
    Yi = function(e, t, n, r, o) {
      ...
      return E(i, function(e, t) {
        return e.filter(g(Ui.hasColspan)).fold(
          function() {
            var e = Io(u, t)
            return r(e)
          },
    ...
    Ki = function(e, t, n, r) {
      ...
      return E(o, function(e, t) {
        return e.filter(g(Ui.hasRowspan)).fold(
          function() {
            var e = Io(i, t)
            return r(e)
          },
    ...
    nu = function(e, t) {
      var n,
        ...
        o,
        i,
        u = $r.percentageBasedSizeRegex().exec(t)
      if (null !== u)
        return (
          (n = u[1]),
          (r = e),
    ...
    du = function(e) {
      return fu(su, e, { validate: v, label: 'function' })
    },
        ...
        combine: function(t) {
          return (
            ...
            function() {
              ...
              return Ae(e, 'width'), Ae(t, 'width'), e
            }
          )
        },
        cursor: e.get,
        ...
        function(e, n, t, r) {
          var o,
            ...
            c =
              ...
              ui(a, i, !0)),
            l = At(n.row(), n.column())
          return Di(l, e, c, n.generators(), t).fold(
            function() {
    ...
    Ku = { 'border-collapse': 'collapse', width: '100%' },
    Ju = { border: '1' },
    $u = function(e) {
    ...
    f.undoManager.transact(function() {
      sa.each(s, function(e) {
        ...
        g(e, 'scope', h.scope),
          ...
          h.align !== d.align && (ga(f, e), da(f, e, h.align))
      }),
        f.focus()
    })
  }
  var Ra = function(t) {
    ...
    Da = function(e, t, n, r, o) {
      ...
      Oe(i, o.styles), de(i, o.attributes)
    ...
    Na = function(r, e, t) {
      var n,
        o,
        i = r.getParam('table_default_styles', Ku, 'object'),
        u = {
          styles: i,
          attributes:
            ((o = r), o.getParam('table_default_attributes', Ju, 'object')),
          percentages: ((n = i.width), d(n) && -1 !== n.indexOf('%') && !oa(r)),
        },
        a = Da(t, e, 0, 0, u)
      ...
      return (
        r.insertContent(s),
        Qt(Fu(r), 'table[data-mce-id="__mce"]')
          .map(function(e) {
            var t, n
            return (
              oa(r) && De(e, 'width', Ne(e, 'width')),
              he(e, 'data-mce-id'),
              (t = r),
  ...
  function Ea(e, t, n, r) {
    if ('TD' === t.tagName || 'TH' === t.tagName) e.setStyle(t, n, r)
      ...
      for (var o = 0; o < t.children.length; o++) Ea(e, t.children[o], n, r)
  }
  var ka,
    Aa = function(e, t, n) {
      var r,
          ...
          t || (t = Na(e, o.cols || 1, o.rows || 1)),
            (function(e, t, n) {
              ...
              if (
                ...
                o.getAttrib(t, 'width') && !ea(e)
                  ? (i.width = (r = n.width) ? r.replace(/px$/, '') : '')
                  : (u.width = Uu(n.width)),
                ea(e)
                  ? ((u['border-width'] = Uu(n.border)),
              ...
              n.style
                ...
                : (u = sa.extend({}, o.parseStyle(o.getAttrib(t, 'style')), u)),
            ...
            !r &&
              o.caption &&
              (((r = i.create('caption')).innerHTML = Sa.ie
                ? '\xa0'
                : '<br data-mce-bogus="1"/>'),
    ...
    Ia = sa.each,
    Ba = function(a, t, c, l, n) {
      var r = Hu(a),
        e = function(e) {
          return function() {
            return R.from(a.dom.getParent(a.selection.getStart(), e)).map(
              xe.fromDom,
            )
          }
        },
        ...
        d = function(e) {
          return { width: ju(e.dom()), height: ju(e.dom()) }
        },
        i = function(n) {
          f().each(function(t) {
            s(t).each(function(i) {
    ...
    Wa = function(e) {
      var t = R.from(e.dom().documentElement)
        .map(xe.fromDom)
        .getOr(e)
      return { parent: C(t), view: C(e), origin: C(eo(0, 0)) }
    },
    Ma = function(e, t) {
      return { parent: C(t), view: C(e), origin: C(eo(0, 0)) }
    },
    ...
    Va =
      ...
      function() {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o = e[r]
          for (var i in o) qa.call(o, i) && (n[i] = ka(n[i], o[i]))
        }
        return n
      }),
    Ga = { resolve: _o('ephox-dragster').resolve },
    Ya = du(['compare', 'extract', 'mutate', 'sink']),
    Xa = du(['element', 'start', 'stop', 'destroy']),
    Ka = du(['forceDrop', 'drop', 'move', 'delayDrop']),
    Ja = Ya({
      ...
      sink: function(e, t) {
        var n,
          ...
          i =
            ((n = t),
            (r = Va({ layerClass: Ga.resolve('blocker') }, n)),
            (o = xe.fromTag('div')),
          ...
          u = Ua(i.element(), 'mousedown', e.forceDrop),
          a = Ua(i.element(), 'mouseup', e.drop),
          c = Ua(i.element(), 'mousemove', e.move),
          l = Ua(i.element(), 'mouseout', e.delayDrop)
        return Xa({
          element: i.element,
          start: function(e) {
            Rt(e, i.element())
  ...
  var Za = function(t, n, e) {
    ...
    tc = function() {
      var n,
        r = La.create({ drag: _a(['xDelta', 'yDelta', 'target']) }),
        o = R.none(),
        e = {
          mutate: function(e, t) {
            n.trigger.drag(e, t)
          },
          events: (n = La.create({ drag: _a(['xDelta', 'yDelta']) })).registry,
        }
      return (
    ...
    oc = function(o, t, i) {
      ...
      var c = function(e, t) {
        ...
        s = function(e) {
          return Zt(e, 'table', f).filter(function(e) {
            return ((t = e), (n = f), Zt(t, '[contenteditable]', n)).exists(nc)
            var t, n
          })
        },
      ...
      return {
        destroy: function() {
          l.unbind(), d.unbind(), r.destroy(), $o(o)
        },
        refresh: function(e) {
          Xo(o, e, i, t)
        },
    ...
    ic = function(e, n) {
      ...
      return (
        t.events.adjustHeight.bind(function(e) {
          ...
          au(e.table(), t, e.row(), r), o.trigger.afterResize(e.table())
        }),
        ...
        t.events.adjustWidth.bind(function(e) {
          ...
          uu(e.table(), t, e.column(), n), o.trigger.afterResize(e.table())
        }),
        {
          on: t.on,
          off: t.off,
    ...
    fc = wo(wo({}, lc), {
      none: function(e) {
        return void 0 === e && (e = undefined), lc.none(e)
      },
    }),
    sc = function(n, e) {
    ...
    gc = { create: q('start', 'soffset', 'finish', 'foffset') },
    hc = xr([
      { before: ['element'] },
      { on: ['element', 'offset'] },
      { after: ['element'] },
    ...
    bc = {
      ...
      getWin: function(e) {
        ...
        return (t = n), xe.fromDom(t.dom().ownerDocument.defaultView)
      },
      range: gc.create,
    },
    wc = function(e, t) {
    ...
    Wc = document.caretPositionFromPoint
      ? function(n, e, t) {
      ...
      : function(o, i, t) {
          return xe.fromPoint(o, i, t).bind(function(r) {
            var e = function() {
              return (
                (e = o), (n = i), (0 === bt((t = r)).length ? Ic : Pc)(e, t, n)
              )
              var e, t, n
            }
    ...
    Uc = function(e) {
      ...
      return Tc(o, n).match({ ltr: t, rtl: t })
    },
    qc = function(e) {
      var t = xe.fromDom(e.anchorNode),
        n = xe.fromDom(e.focusNode)
      return Fc(t, e.anchorOffset, n, e.focusOffset)
        ? R.some(gc.create(t, e.anchorOffset, n, e.focusOffset))
        : (function(e) {
            if (0 < e.rangeCount) {
    ...
    Vc = function(e, t) {
      var n,
        r,
        o = ((n = t), (r = e.document.createRange()), wc(r, n), r)
      jc(e, o)
    },
    Gc = function(e) {
      return ((t = e),
    ...
    rl = { create: q('selection', 'kill') },
    ol = function(e, t, n, r) {
      return { start: C(pc.on(e, t)), finish: C(pc.on(n, r)) }
    },
    il = {
        ...
        : sr(r, t, e).bind(function(e) {
            ...
            return 0 < t.length
              ? (o(n, t, e.start(), e.finish()),
                R.some(rl.create(R.some(il.makeSitus(r, 0, r, yn(r))), !0)))
              : R.none()
          })
    },
    al = {
    ...
    dl = [
      { current: ll, next: fl, fallback: R.none() },
      { current: fl, next: sl, fallback: R.some(ll) },
      { current: sl, next: sl, fallback: R.some(fl) },
    ],
    ...
    yl = $n(),
    xl = function(e, t) {
      return (r = t), bl((n = yl), e, vl(n), r)
      var n, r
    },
    Cl = function(e, t) {
      return (r = t), wl((n = yl), e, vl(n), r)
      var n, r
    },
    Rl = q('element', 'offset'),
    Sl =
      (q('element', 'deltaOffset'),
    ...
    Ol =
      (q('ancestor', 'descendants', 'element', 'index'),
    ...
    Wl = {
      ...
      moveBottomTo: function(e, t) {
        ...
        return Bl({ left: e.left(), top: t - n, right: e.right(), bottom: t })
      },
      moveTopTo: function(e, t) {
        var n = e.bottom() - e.top()
        return Bl({ left: e.left(), top: t, right: e.right(), bottom: t + n })
      },
      getTop: function(e) {
        return e.top()
      },
    ...
    Fl = function(e, t) {
      return ce(t)
        ? _l(e, t).map(Ml)
        : le(t)
        ? e.getRangedRect(t, 0, t, yn(t)).map(Ml)
        : R.none()
    },
    jl = xr([{ none: [] }, { retry: ['caret'] }]),
    zl = function(t, e, r) {
      return ((n = e),
      (o = Tu),
      Vt(
    ...
    Hl = {
      ...
      adjuster: function(e, t, n, r, o) {
        ...
        return Math.abs(n.top() - r.top()) < 1
          ...
          ? jl.retry(i)
          : n.bottom() === o.top()
          ? jl.retry(Wl.moveUp(o, 1))
          : zl(e, t, o)
          ? jl.retry(Wl.translate(i, 5, 0))
          : jl.none()
      },
      move: Wl.moveUp,
      gather: xl,
      ...
      return 0 === u
        ...
        : ((c = n),
          ...
          c
            ...
            .isSome()
            ? ((t = i), (a = u - 1), ql(n, (e = r), o, e.move(t, 5), a))
      ...
      return 0 === c
        ...
        : $l(r, o, i, u, a).bind(function(e) {
            ...
            return Dl.cata(
              ...
              function(e) {
                return ft(i, e) && 0 === u
                  ? Kl(r, i, u, Wl.moveUp, a)
                  : Xl(r, o, e, 0, a, c - 1)
              },
              function(e) {
                return ft(i, e) && u === yn(e)
                  ? Kl(r, i, u, Wl.moveDown, a)
                  : Xl(r, o, e, yn(e), a, c - 1)
              },
            )
          })
    ...
    Jl = function(e, t, n) {
      return Yl.browser.isChrome() ||
        Yl.browser.isSafari() ||
        Yl.browser.isFirefox() ||
        Yl.browser.isEdge()
        ? t.otherRetry(e, n)
        : Yl.browser.isIE()
        ? t.ieRetry(e, n)
    ...
    Ql = function(t, n, r) {
      ...
      o.getSelection().bind(function(r) {
        return Pl(i, r.finish(), r.foffset(), u).fold(
          function() {
      ...
      return Zl.browser.isIE()
        ...
        : i(r, t).orThunk(function() {
            return tf(e, t, n, r, o).map(function(e) {
              ...
              return rl.create(
                R.some(
                  il.makeSitus(t.start(), t.soffset(), t.finish(), t.foffset()),
                ),
                !0,
              )
            })
    ...
    sf = lf(40),
    df = {
      ltr: { isBackward: lf(37), isForward: lf(39) },
      rtl: { isBackward: lf(39), isForward: lf(37) },
      isUp: ff,
      isDown: sf,
      ...
      function(a) {
        return {
          ...
          scrollBy: function(e, t) {
            ...
            ;(n = e),
              (r = t),
              ((o = xe.fromDom(a.document)) !== undefined
                ? o.dom()
                : m.document
        ...
        return {
          keydown: function(e, t, n, r, o, i) {
            var u = e.raw(),
              a = u.which,
              c = !0 === u.shiftKey
            return dr(l, s.selectedSelector()).fold(
              function() {
                return df.isDown(a) && c
                  ? b(rf, d, l, f, cf.down, r, t, s.selectRange)
                  : df.isUp(a) && c
                  ? b(rf, d, l, f, cf.up, r, t, s.selectRange)
                  : df.isDown(a)
                  ? b(nf, d, f, cf.down, r, t, uf)
                  : df.isUp(a)
                  ? b(nf, d, f, cf.up, r, t, of)
                  : R.none
              },
              function(t) {
                var e = function(e) {
          ...
          keyup: function(n, r, o, i, u) {
            return dr(l, s.selectedSelector()).fold(function() {
              ...
              return 0 == (!0 === e.shiftKey)
                ? R.none()
                : df.isNavigation(t)
                ? al.sync(l, f, r, o, i, u, s.selectRange)
                : R.none()
            }, R.none)
          },
        }
    ...
    vf = function(r, e) {
      k(e, function(e) {
        var t, n
        ;(n = e), Do((t = r)) ? t.dom().classList.remove(n) : No(t, n), ko(t)
      })
    },
    bf = {
      byClass: function(o) {
        ...
        return {
          ...
          selectRange: function(e, t, n, r) {
            u(e), k(t, i), Eo(n, o.firstSelected()), Eo(r, o.lastSelected())
          },
  ...
  var xf = sa.each,
    ...
    Rf = function(t) {
      var e,
        n =
          '' === (e = t.getParam('table_toolbar', Xu)) || !1 === e
            ? []
            : d(e)
            ? e.split(/[ ,]/)
            : h(e)
    ...
    Tf = function(n, r) {
      return {
        ...
        setClipboardRows: function(e) {
          return (t = r), (n = E(e, xe.fromDom)), void t.set(R.from(n))
          var t, n
        },
    ...
    var n,
      ...
      i =
        ((n = t),
        {
          get: function() {
            var e = Fu(n)
            return hr(e, yr.selectedSelector()).fold(
              function() {
