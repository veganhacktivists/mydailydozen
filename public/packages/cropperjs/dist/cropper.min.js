    ...
    Rt = {
      bind: function() {
        ...
        at(e.cropstart) && Mt(t, M, e.cropstart),
          ...
          e.toggleDragModeOnDblclick &&
            Mt(i, R, (this.onDblclick = this.dblclick.bind(this))),
      ...
      unbind: function() {
        ...
        at(e.cropstart) && yt(t, M, e.cropstart),
          ...
          e.zoomable &&
            e.zoomOnWheel &&
            yt(i, 'wheel', this.onWheel, { passive: !1, capture: !0 }),
              ...
              value: function() {
                if (this.sized && !this.ready) {
                  ...
                  ;(this.container = a),
                    ...
                    pt(s, X),
                    e.guides ||
                      pt(s.getElementsByClassName(''.concat(l, '-dashed')), X),
                    e.center ||
                      pt(s.getElementsByClassName(''.concat(l, '-center')), X),
