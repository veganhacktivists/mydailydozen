...
;(function() {
  CKEDITOR.plugins.add('language', {
    requires: 'menubutton',
    lang:
      'ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-au,en-gb,eo,es,es-mx,et,eu,fa,fi,fo,fr,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,oc,pl,pt,pt-br,ro,ru,sk,sl,sq,sr,sr-latn,sv,tr,tt,ug,uk,vi,zh,zh-cn',
    icons: 'language',
    hidpi: !0,
    init: function(a) {
