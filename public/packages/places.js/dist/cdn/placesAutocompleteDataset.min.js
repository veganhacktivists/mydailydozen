!(function(t, n) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? (exports.placesAutocompleteDataset = n())
    : (t.placesAutocompleteDataset = n())
})(window, function() {
  return (
    (o = {}),
    (r.m = e = {
      1: function(t, n, e) {
        ...
        var z = {},
          j = {}
        n.a = function(t) {
          var n, e, o, r, a, i, c, s, u, l, p, d, h, g, v, f, m, y, b, w, O, x
          return (
            (n = P({}, z, {}, t)),
            (e = n.hitsPerPage),
            (o = n.postcodeSearch),
            (r = n.aroundLatLng),
            (a = n.aroundRadius),
            (i = n.aroundLatLngViaIP),
            (c = n.insideBoundingBox),
            (s = n.insidePolygon),
            (u = n.getRankingInfo),
            (l = n.countries),
            (p = n.language),
            ...
            (h = {
              countries: l,
              hitsPerPage: e || 5,
              language: p || navigator.language.split('-')[0],
              type: d,
            }),
            Array.isArray(l) &&
            ...
            o && (h.restrictSearchableAttributes = 'postcode'),
            (z = P({}, h, {
              aroundRadius: a,
              insideBoundingBox: c,
              insidePolygon: s,
            ...
            (g = P({}, j, {}, t)),
            (v = g.useDeviceLocation),
            (f = void 0 !== v && v),
            (m = g.computeQueryParams),
            (y =
              void 0 === m
                ? function(t) {
                    return t
            ...
            (j = {
              ...
              onError:
                void 0 === x
                  ...
                  : x,
              onRateLimitReached: g.onRateLimitReached,
              onInvalidCredentials: g.onInvalidCredentials,
            }),
            { params: z, controls: j }
          )
        }
      ...
      18: function(t, n) {
        ...
        function e(t, n) {
          ...
          var e,
            ...
            i = c.indexOf(a)
          return (
            -1 === i && ((i = c.push(a) - 1), (s[i] = {})),
            void 0 !== s[i] && void 0 !== s[i][r]
              ? (e = s[i][r])
              : ((e = s[i][r] =
        ...
        ;(t.exports = e), (t.exports.insertCss = e)
      },
      19: function(t, n, e) {
        'use strict'
        e.r(n)
        ...
        function u(t) {
          var n = c({}, a.a, {}, t.templates)
          return {
            source: (function(t) {
              var n = t.algoliasearch,
                e = t.clientOptions,
                o = t.apiKey,
                r = t.appId,
                a = t.hitsPerPage,
                ...
                z =
                  void 0 === P
                    ...
                    : P,
                j = t.onRateLimitReached,
                L = t.onInvalidCredentials,
                V = t.type,
                S = n.initPlaces(r, o, e)
              S.as.addAlgoliaAgent('Algolia Places '.concat(k.default))
              var C,
                H = Object(_.a)({
                  hitsPerPage: a,
                  type: V,
                  ...
                  getRankingInfo: d,
                  formatInputValue: g,
                  computeQueryParams: f,
                  useDeviceLocation: y,
                  onHits: x,
                  onError: z,
                  onRateLimitReached: j,
                  onInvalidCredentials: L,
                }),
                I = H.params,
                D = H.controls,
                M = null
              function R(o, t) {
                ...
                return (
                  C && (n.aroundLatLng = C),
                  S.search(D.computeQueryParams(n))
                    .then(function(e) {
                      var t = e.hits.map(function(t, n) {
                        return Object(
                          A.a,
                        )({ formatInputValue: D.formatInputValue, hit: t, hitIndex: n, query: o, rawAnswer: e })
                      })
                      return D.onHits({ hits: t, query: o, rawAnswer: e }), t
                    })
                    .then(t)
                    .catch(function(t) {
                      403 !== t.statusCode ||
                      'Invalid Application-ID or API key' !== t.message
                        ? 429 !== t.statusCode
                          ? D.onError(t)
                          : D.onRateLimitReached()
                        : D.onInvalidCredentials()
                    })
                )
              }
              return (
                D.useDeviceLocation &&
                  (M = navigator.geolocation.watchPosition(function(t) {
                    var n = t.coords
                    C = ''.concat(n.latitude, ',').concat(n.longitude)
                  })),
                (R.configure = function(t) {
                  var n = Object(_.a)(B({}, I, {}, D, {}, t))
                  ;(I = n.params),
                    (D = n.controls).useDeviceLocation && null === M
                      ? (M = navigator.geolocation.watchPosition(function(t) {
                          var n = t.coords
                          C = ''.concat(n.latitude, ',').concat(n.longitude)
                        }))
                      : D.useDeviceLocation ||
                        null === M ||
                        (navigator.geolocation.clearWatch(M), (C = M = null))
                }),
                R
              )
            })(c({}, t, { formatInputValue: n.value, templates: void 0 })),
            templates: n,
            displayKey: 'value',
            name: 'places',
            cache: !1,
      ...
      9: function(t, n, e) {
        ...
        function b(t) {
          for (var n = t[0].value, e = [], o = 1; o < t.length; ++o)
            'none' !== t[o].matchLevel &&
              e.push({ index: o, words: t[o].matchedWords })
          return 0 === e.length
            ? n
            : (e.sort(function(t, n) {
                return t.words > n.words
                  ? -1
                  : t.words < n.words
                  ? 1
                  : t.index - n.index
              ...
              0 === e[0].index
                ? ''.concat(n, ' (').concat(t[e[1].index].value, ')')
                : ''.concat(t[e[0].index].value, ' (').concat(n, ')'))
        }
        function o(t) {
          var n = t.formatInputValue,
            e = t.hit,
            o = t.hitIndex,
            r = t.query,
            a = t.rawAnswer
          try {
            var i = e.locale_names[0],
              c = e.country,
              s =
                e.administrative && e.administrative[0] !== i
                  ? e.administrative[0]
                  : void 0,
              u = e.city && e.city[0] !== i ? e.city[0] : void 0,
              l = e.suburb && e.suburb[0] !== i ? e.suburb[0] : void 0,
              p = e.county && e.county[0] !== i ? e.county[0] : void 0,
              d =
                e.postcode && e.postcode.length
                  ? (function(t, n) {
                      for (var e = n[0].value, o = [], r = 1; r < n.length; ++r)
                        'none' !== n[r].matchLevel &&
                          o.push({ index: r, words: n[r].matchedWords })
                      return 0 === o.length
                        ? { postcode: t[0], highlightedPostcode: e }
                        : (o.sort(function(t, n) {
                            return t.words > n.words
                              ? -1
                              : t.words < n.words
                          ...
                          {
                            postcode: t[o[0].index],
                            highlightedPostcode: n[o[0].index].value,
                          })
                    })(e.postcode, e._highlightResult.postcode)
                  : { postcode: void 0, highlightedPostcode: void 0 },
              h = d.postcode,
              g = d.highlightedPostcode,
              v = {
                name: b(e._highlightResult.locale_names),
                city: u ? b(e._highlightResult.city) : void 0,
                administrative: s
                  ? b(e._highlightResult.administrative)
                  : void 0,
                country: c ? e._highlightResult.country.value : void 0,
                suburb: l ? b(e._highlightResult.suburb) : void 0,
                county: p ? b(e._highlightResult.county) : void 0,
                postcode: g,
              },
              f = {
                name: i,
                ...
                type: (function(t) {
                  ...
                  for (var e in n) if (-1 !== t.indexOf(e)) return n[e]
                  return 'address'
                })(e._tags),
                latlng: { lat: e._geoloc.lat, lng: e._geoloc.lng },
                postcode: h,
                postcodes:
                  e.postcode && e.postcode.length ? e.postcode : void 0,
              }
            return (function(n) {
              for (var t = 1; t < arguments.length; t++) {
                var e = null != arguments[t] ? arguments[t] : {}
            ...
            return (
              console.error('Could not parse object', e),
              console.error(t),
