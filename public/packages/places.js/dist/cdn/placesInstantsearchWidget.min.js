!(function(t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? (exports.placesInstantsearchWidget = e())
    : (t.placesInstantsearchWidget = e())
})(window, function() {
  return (
    (r = {}),
    (i.m = n = [
      ...
      function(t, e, n) {
        ...
        e.a = function(t) {
          ...
          return (
            ...
            (i = e.aroundLatLng),
            (o = e.aroundRadius),
            (s = e.aroundLatLngViaIP),
            (a = e.insideBoundingBox),
            (c = e.insidePolygon),
            (u = e.getRankingInfo),
            (l = e.countries),
            (h = e.language),
            ...
            Array.isArray(l) &&
              (f.countries = f.countries.map(function(t) {
                return t.toLowerCase()
              })),
            'string' == typeof f.language &&
              (f.language = f.language.toLowerCase()),
            i
              ? (f.aroundLatLng = i)
              : void 0 !== s && (f.aroundLatLngViaIP = s),
            r && (f.restrictSearchableAttributes = 'postcode'),
            (C = O({}, f, {
              aroundRadius: o,
              insideBoundingBox: a,
              insidePolygon: c,
            ...
            (d = O({}, S, {}, t)),
            (g = d.useDeviceLocation),
            (m = void 0 !== g && g),
            (v = d.computeQueryParams),
            (y =
              void 0 === v
                ? function(t) {
                    return t
          ...
          try {
            var s = n.locale_names[0],
                ...
                n.postcode && n.postcode.length
                  ? (function(t, e) {
                      for (var n = e[0].value, r = [], i = 1; i < e.length; ++i)
                        'none' !== e[i].matchLevel &&
                          r.push({ index: i, words: e[i].matchedWords })
                      return 0 === r.length
              ...
              g = {
                ...
                administrative: c
                  ? b(n._highlightResult.administrative)
                  : void 0,
      ...
      function(t, e) {
        ...
        function n(t, e) {
          ...
          var n,
            ...
            s = a.indexOf(o)
          return (
            -1 === s && ((s = a.push(o) - 1), (c[s] = {})),
            void 0 !== c[s] && void 0 !== c[s][i]
              ? (n = c[s][i])
              : ((n = c[s][i] =
            ...
            n.styleSheet ? (n.styleSheet.cssText += t) : (n.textContent += t),
            n
          )
        }
        ...
        function u(t) {
          ...
          return {
            source: (function(t) {
              ...
              j.as.addAlgoliaAgent('Algolia Places '.concat(q.default))
              var E,
                T = Object(D.a)({
                  hitsPerPage: o,
                  type: P,
              ...
              function R(r, t) {
                ...
                return (
                  E && (e.aroundLatLng = E),
                  j
                    .search(I.computeQueryParams(e))
                    .then(function(n) {
                      var t = n.hits.map(function(t, e) {
                        return Object(
                          N.a,
                        )({ formatInputValue: I.formatInputValue, hit: t, hitIndex: e, query: r, rawAnswer: n })
                      })
                      return I.onHits({ hits: t, query: r, rawAnswer: n }), t
                    })
                    .then(t)
                    .catch(function(t) {
                      403 !== t.statusCode ||
              ...
              return (
                ...
                (R.configure = function(t) {
                  var e = Object(D.a)($({}, L, {}, I, {}, t))
                  ;(L = e.params),
                    (I = e.controls).useDeviceLocation && null === k
                      ? (k = navigator.geolocation.watchPosition(function(t) {
                          var e = t.coords
                          E = ''.concat(e.latitude, ',').concat(e.longitude)
                        }))
                      : I.useDeviceLocation ||
                        null === k ||
                        (navigator.geolocation.clearWatch(k), (E = k = null))
                }),
                R
              )
            })(a({}, t, { formatInputValue: e.value, templates: void 0 })),
            templates: e,
            displayKey: 'value',
            name: 'places',
            cache: !1,
      ...
      function(t, e, n) {
        ...
        var T = function(t) {
          ...
          function b(t, e) {
            ...
            if (r)
              return y
                .reverse(j({}, x, { aroundLatLng: r }))
                .then(function(n) {
                  var t = n.hits.map(function(t, e) {
                    return Object(
                      S.a,
                    )({ formatInputValue: _.formatInputValue, hit: t, hitIndex: e, query: r, rawAnswer: n })
                  })
                  return _.onHits({ hits: t, query: r, rawAnswer: n }), t
                })
                .then(e)
                .catch(function(t) {
                  403 !== t.statusCode ||
                  'Invalid Application-ID or API key' !== t.message
                    ? 429 !== t.statusCode
                      ? _.onError(t)
                      : _.onRateLimitReached()
                    : _.onInvalidCredentials()
                })
            var n = new Error(
          ...
          var w = Object(C.a)({
            ...
            _ = w.controls
          return (
            (b.configure = function(t) {
              var e = Object(C.a)(j({}, x, {}, _, {}, t))
              return (x = E(e.params)), (_ = e.controls), b
            }),
            b
          )
        }
        ...
        function k(t) {
          ...
          if (e instanceof NodeList) {
            if (1 < e.length) throw new Error(O.multiContainers)
            return k(L({}, t, { container: e[0] }))
          }
          if ('string' == typeof e) {
            var s = document.querySelectorAll(e)
            return k(L({}, t, { container: s }))
          }
          if (!(e instanceof HTMLInputElement)) throw new Error(O.badContainer)
          var a = new v.a(),
            ...
            l = Object(w.default)(
              L({}, t, {
                ...
                onRateLimitReached: function() {
                  0 !== a.listenerCount('limit')
                    ? a.emit('limit', { message: O.rateLimitReached })
                    : console.log(O.rateLimitReached)
                },
                onInvalidCredentials: function() {
                  t && t.appId && t.appId.startsWith('pl')
                    ? console.error(O.invalidCredentials)
                    : console.error(O.invalidAppId)
                },
                container: void 0,
              }),
            ),
          ...
          f.setAttribute('type', 'button'),
            f.setAttribute('aria-label', 'clear'),
            r &&
              r.clearButton &&
              r.clearButton instanceof Object &&
              I(f, r.clearButton),
            f.classList.add(''.concat(c, '-input-icon')),
            f.classList.add(''.concat(c, '-icon-clear')),
            (f.innerHTML = x),
            p.appendChild(f),
            (f.style.display = 'none')
          var d = document.createElement('button')
          d.setAttribute('type', 'button'),
            d.setAttribute('aria-label', 'focus'),
            r &&
              r.pinButton &&
              r.pinButton instanceof Object &&
              I(d, r.pinButton),
            d.classList.add(''.concat(c, '-input-icon')),
            d.classList.add(''.concat(c, '-icon-pin')),
            (d.innerHTML = _.a),
            p.appendChild(d),
            d.addEventListener('click', function() {
              l.source.configure({ useDeviceLocation: !0 }), h.focus()
            }),
            f.addEventListener('click', function() {
              h.autocomplete.setVal(''),
                h.focus(),
                (f.style.display = 'none'),
                (d.style.display = ''),
                a.emit('clear')
          ...
          function g() {
            ...
            '' === t
              ? ((d.style.display = ''),
                (f.style.display = 'none'),
                m !== t && a.emit('clear'))
              : ((f.style.display = ''), (d.style.display = 'none')),
              (m = t)
          }
          var m = ''
          ...
          return (
            ...
            (a.destroy = function() {
              var t
              p
                .querySelector('.'.concat(c, '-input'))
                .removeEventListener('input', g),
                (t = h.autocomplete).destroy.apply(t, arguments)
            }),
            (a.setVal = function() {
              var t
              '' === (m = arguments.length <= 0 ? void 0 : arguments[0])
                ? ((d.style.display = ''), (f.style.display = 'none'))
                : ((f.style.display = ''), (d.style.display = 'none')),
                (t = h.autocomplete).setVal.apply(t, arguments)
            }),
            (a.autocomplete = h),
            (a.search = function() {
              var e =
        ...
        ;(function(t) {
          ...
          function o(e, t, n) {
            ...
            if (!0 !== n._allowEmptyCredentials && !t)
              throw new _.AlgoliaSearchError('Please provide an API key. ' + a)
          ...
          ;(o.prototype.initIndex = function(t) {
            ...
            (o.prototype._jsonRequest = function(u) {
              ...
              if (
                ...
                m._useCache && m._useRequestCache && l && (h += '_body_' + l),
                x(m._useRequestCache, g, h))
              ) {
                ...
                if (v >= m.hosts[u.hostType].length)
                  return !b || y
                    ...
                    : (f('switching to fallback'),
                      ...
                      o.jsonBody && (o.body = O(o.jsonBody)),
                      (p = m._computeRequestHeaders({
                        additionalUA: d,
                        headers: u.headers,
                      })),
                      (o.timeouts = m._getTimeoutsForRequest(u.hostType)),
                  ...
                  r.call(m, e, i).then(
                    ...
                    function(t) {
                      ...
                      return (
                        ...
                        (v >= m.hosts[u.hostType].length && (y || !b))
                          ? ((t.debugData = w), m._promise.reject(t))
                          : t instanceof _.RequestTimeout
                          ? (f('retrying request with higher timeout'),
            ...
            (o.prototype._computeRequestHeaders = function(t) {
              ...
              return (
                !1 !== t.withApiKey && (n['x-algolia-api-key'] = this.apiKey),
            ...
            (o.prototype._setHostIndexByType = function(t, e) {
              ...
              return (
                (n[e] = t), this._partialAppIdDataUpdate({ hostIndexes: n }), t
              )
            }),
        ...
        ;((t.exports = o).prototype.clearCache = function() {
          ...
          (o.prototype.browse = function(t, e, n) {
            ...
            return this.as._jsonRequest({
              method: 'POST',
              url:
                '/1/indexes/' + encodeURIComponent(this.indexName) + '/browse',
              body: { params: s },
              hostType: 'read',
              callback: n,
            })
            ...
            t = {
              set: function(e, t) {
                ...
                try {
                  ...
                  return (
                    (n[e] = t), (r.localStorage[o] = JSON.stringify(n)), n[e]
                  )
                } catch (t) {
                  return a(e, t)
                }
      ...
      function(t, e, a) {
        ...
        t.exports = function(t, e) {
          ...
          ;(e = e || ''),
            (o.version = a(53)),
            (o.ua = 'Algolia for JavaScript (' + o.version + '); ' + e),
            (o.initPlaces = r(o)),
                  ...
                  ;(r = setTimeout(a, l.timeouts.connect)),
                    ...
                    (o.onload = function() {
                      ...
                      try {
                        ...
                        e = new h.UnparsableJSON({ more: o.responseText })
                      }
      ...
      function(t, e, n) {
        ...
        t.exports = function(t, e, n) {
          if ('GET' !== e.method)
            return void n(
              new Error(
                'Method ' + e.method + ' ' + t + ' is not supported by JSONP.',
              ),
            )
          e.debug('JSONP: start')
          var r = !1,
          ...
          ;(s.onreadystatechange = function() {
            ...
            (s.onerror = function() {
              e.debug('JSONP: Script error'),
                c || i || (h(), n(new p.JSONPScriptError()))
            }),
            (s.async = !0),
            (s.defer = !0),
            (s.src = t),
      ...
      function(t, e, s) {
        t.exports = function(o) {
          return function(t, e, n) {
            ...
            return (
              (i.search = c('query', '/1/places/query')),
        ...
        t.exports = function(t, e, n, r) {
          ...
          for (var l = 0; l < u; ++l) {
            var h,
              ...
              m = g.indexOf(n)
            ;(p =
              0 <= m ? ((h = g.substr(0, m)), g.substr(m + 1)) : ((h = g), '')),
            ...
            (function(l) {
              ...
              function w(i, t, e, o, s, a, c) {
                ...
                t.split(/\s/).forEach(function(t) {
                  ...
                  var r = (n.del = a) || e
                  ;(n.proxy = function(t) {
                    if (!(t = O(t)).isImmediatePropagationStopped()) {
                      try {
                    ...
                    'addEventListener' in i &&
                      i.addEventListener(b(n.e), n.proxy, y(n, c))
                })
              }
                  ...
                  s(e, t, n, r).forEach(function(t) {
                    delete d[o][t.i],
                      'removeEventListener' in e &&
                        e.removeEventListener(b(t.e), t.proxy, y(t, i))
                  })
                })
              }
              ;(o.click = o.mousedown = o.mouseup = o.mousemove =
                'MouseEvents'),
                (l.event = { add: w, remove: x }),
                (l.proxy = function(t, e) {
                  ...
                  if (f(t)) {
                    function r() {
                      return t.apply(
                        e,
                        n ? n.concat(p.call(arguments)) : arguments,
                      )
                    }
                    return (r._zid = m(t)), r
                  }
              ...
              (r = (function() {
                ...
                function H(t, e) {
                  return 'number' != typeof e || d[$(t)] ? e : e + 'px'
                }
                function V(t) {
                ...
                return (
                  ...
                  (P.init = function(t, e) {
                    ...
                    if ('string' == typeof t)
                      if ('<' == (t = t.trim())[0] && g.test(t))
                        (n = P.fragment(t, RegExp.$1, e)), (t = null)
                      else {
                        if (e !== c) return u(e).find(t)
                        n = P.qsa(p, t)
                      }
                    else {
                      if (I(t)) return u(p).ready(t)
                      if (P.isZ(t)) return t
                      if (T(t))
                        (r = t),
                          (n = l.call(r, function(t) {
                            return null != t
                          }))
                      else if (D(t)) (n = [t]), (t = null)
                      else if (g.test(t))
                        (n = P.fragment(t.trim(), RegExp.$1, e)), (t = null)
                      else {
                        if (e !== c) return u(e).find(t)
                        n = P.qsa(p, t)
                      }
                  ...
                  (u.map = function(t, e) {
                    ...
                    else for (i in t) null != (n = e(t[i], i)) && s.push(n)
                  ...
                  (u.fn = {
                    ...
                    each: function(n) {
                      return (
                        i.every.call(this, function(t, e) {
                    ...
                    is: function(t) {
                      return 0 < this.length && P.matches(this[0], t)
                    },
                    not: function(e) {
                      var n = []
                      if (I(e) && e.call !== c)
                    ...
                    closest: function(n, r) {
                      ...
                      return (
                        this.each(function(t, e) {
                          for (
                            ;
                            e && !(o ? 0 <= o.indexOf(e) : P.matches(e, n));

                          )
                            e = e !== r && !R(e) && e.parentNode
                    ...
                    wrap: function(e) {
                      ...
                      return this.each(function(t) {
                        u(this).wrapAll(
                          n ? e.call(this, t) : i ? r.cloneNode(!0) : r,
                        )
                      })
                    },
                    wrapAll: function(t) {
                    ...
                    prev: function(t) {
                      return u(this.pluck('previousElementSibling')).filter(
                        t || '*',
                      )
                    },
                    next: function(t) {
                    ...
                    attr: function(e, n) {
                      ...
                      return 'string' != typeof e || 1 in arguments
                        ? this.each(function(t) {
                            if (1 === this.nodeType)
                              if (D(e)) for (s in e) U(this, s, e[s])
                              else
                                U(this, e, B(this, n, t, this.getAttribute(e)))
                          })
                        : 0 in this &&
                          1 == this[0].nodeType &&
                      ...
                      if (this.length) {
                        var t = this[0],
                          ...
                          r = y.test(e[0].nodeName)
                            ...
                            : e.offset()
                        return (
                          (n.top -= parseFloat(u(t).css('margin-top')) || 0),
                          (n.left -= parseFloat(u(t).css('margin-left')) || 0),
                          (r.top +=
                            parseFloat(u(e[0]).css('border-top-width')) || 0),
                          (r.left +=
                            parseFloat(u(e[0]).css('border-left-width')) || 0),
                  ...
                  ['after', 'prepend', 'before', 'append'].forEach(function(
                    ...
                    ;(u.fn[e] = function() {
                      ...
                      (u.fn[
                        a ? e + 'To' : 'insert' + (s ? 'Before' : 'After')
                      ] = function(t) {
                        return u(t)[e](this), this
                      })
                  }),
                  (P.Z.prototype = F.prototype = u.fn),
                  (P.uniq = n),
                  (P.deserializeValue = J),
                  (u.zepto = P),
                  u
                )
              })()),
                ...
                var r,
                  ...
                  s =
                    ...
                    (c[o] =
                      ((r = t),
                      (i = {}),
                      a.each(r.attributes || h, function(t, e) {
                        0 == e.name.indexOf('data-') &&
                          (i[
                            u(e.name.replace('data-', ''))
                          ] = a.zepto.deserializeValue(e.value))
                      }),
                      i))
      ...
      function(t, e, n) {
        ...
        function p(t) {
          ...
          ;(this.css = t.css = a.mixin({}, h, t.appendTo ? h.appendTo : {})),
            (this.cssClasses = t.cssClasses = a.mixin(
              {},
              h.defaultClasses,
              t.cssClasses || {},
            )),
            (this.cssClasses.prefix = t.cssClasses.formattedPrefix = a.formatPrefix(
          ...
          var r = (function(t) {
            ...
            ;(i = e
              ...
              .val('')
              .addClass(a.className(t.cssClasses.prefix, t.cssClasses.hint, !0))
        ...
        a.mixin(p.prototype, {
              ...
              a.each(t.keyboardShortcuts, function(t) {
                ...
                c.element(document).keydown(function(t) {
                  ...
                  if (
                    ...
                    ;-1 !== o.indexOf(r) &&
                      (i.focus(), t.stopPropagation(), t.preventDefault())
                  }
                })
            }
          },
          ...
          _onEnterKeyed: function(t, e) {
            ...
            n
              ...
              : this.autoselect && r && (this._select(r, i), e.preventDefault())
          },
          ...
          _autocomplete: function(t) {
            ...
            ;(e = this.input.getHint()),
              ...
              e &&
                ...
                this.eventBus.trigger('autocompleted', i.raw, i.datasetName))
          },
      ...
      function(t, e, n) {
        ...
        function o(t) {
          var e,
            ...
            o,
            s = this
          ;(t = t || {}).input || c.error('input is missing'),
            (e = c.bind(this._onBlur, this)),
            (n = c.bind(this._onFocus, this)),
            (r = c.bind(this._onKeydown, this)),
            (i = c.bind(this._onInput, this)),
            (this.$hint = u.element(t.hint)),
            (this.$input = u
              .element(t.input)
              .on('blur.aa', e)
              .on('focus.aa', n)
          ...
          c.mixin(o.prototype, r, {
            ...
            _checkInputValue: function() {
              ...
              ;(t = this.getInputValue()),
                ...
                (n =
                  !(
                    !(e = o.normalizeQuery(r) === o.normalizeQuery(i)) ||
                    !this.query
      ...
      function(t, e, n) {
        ...
        function l() {
          r &&
            i &&
            ((r = !1), i.length ? (c = i.concat(c)) : (a = -1), c.length && h())
        }
        function h() {
          if (!r) {
            r = !(u = !1)
      ...
      function(t, e, n) {
        ...
        function l(i) {
          var t,
            ...
            n,
            o = this
          ;(i = i || {}).menu || a.error('menu is required'),
            a.isArray(i.datasets) ||
              a.isObject(i.datasets) ||
              a.error('1 or more datasets required'),
            i.datasets || a.error('datasets is required'),
            (this.isOpen = !1),
            (this.isEmpty = !0),
            (this.minLength = i.minLength || 0),
            (this.templates = {}),
            (this.appendTo = i.appendTo || !1),
            (this.css = a.mixin({}, u, i.appendTo ? u.appendTo : {})),
            (this.cssClasses = i.cssClasses = a.mixin(
              {},
              u.defaultClasses,
              i.cssClasses || {},
            )),
            (this.cssClasses.prefix =
              i.cssClasses.formattedPrefix ||
              a.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix)),
            (t = a.bind(this._onSuggestionClick, this)),
            (e = a.bind(this._onSuggestionMouseEnter, this)),
            (n = a.bind(this._onSuggestionMouseLeave, this))
          var r = a.className(
            this.cssClasses.prefix,
          ...
          ;(this.$menu = c
            .element(i.menu)
            .on('mouseenter.aa', r, e)
            .on('mouseleave.aa', r, n)
            .on('click.aa', r, t)),
            (this.$container = i.appendTo ? i.wrapper : this.$menu),
            i.templates &&
              i.templates.header &&
              ((this.templates.header = a.templatify(i.templates.header)),
              this.$menu.prepend(this.templates.header())),
            i.templates &&
              i.templates.empty &&
              ((this.templates.empty = a.templatify(i.templates.empty)),
              ...
              this.$empty.hide()),
            (this.datasets = a.map(i.datasets, function(t) {
              return (
                (e = o.$menu),
                (n = t),
                (r = i.cssClasses),
                new l.Dataset(a.mixin({ $menu: e, cssClasses: r }, n))
              )
              var e, n, r
            })),
            ...
            i.templates &&
              i.templates.footer &&
              ((this.templates.footer = a.templatify(i.templates.footer)),
        ...
        a.mixin(l.prototype, r, {
          ...
          _onSuggestionMouseEnter: function(t) {
            ...
            if (
              !e.hasClass(
                a.className(this.cssClasses.prefix, this.cssClasses.cursor, !0),
              )
            ) {
              this._removeCursor()
              var n = this
          ...
          _getSuggestions: function() {
            return this.$menu.find(
              a.className(this.cssClasses.prefix, this.cssClasses.suggestion),
            )
          },
          _getCursor: function() {
            return this.$menu
              .find(a.className(this.cssClasses.prefix, this.cssClasses.cursor))
              .first()
          },
      ...
      function(t, e, n) {
        ...
        function i(t) {
          ...
          ;((t = t || {}).templates = t.templates || {}),
            ...
            (this.name =
              void 0 === t.name || null === t.name ? l.getUniqueId() : t.name),
            ...
            (this.css = l.mixin({}, s, t.appendTo ? s.appendTo : {})),
          ...
          ;(this.$el =
            t.$menu && 0 < t.$menu.find(o + '-' + this.name).length
              ? h.element(t.$menu.find(o + '-' + this.name)[0])
              : h.element(
                  p.dataset
              ...
              if (this.$el) {
                ...
                if (
                  ...
                  this.$el
                    ...
                    .prepend(s.templates.header ? r.apply(this, t) : null)
                    .append(s.templates.footer ? i.apply(this, t) : null)
                else if (n)
                  this.$el
                    .html(
                      function() {
                        ...
                        return (
                          (t = h.element(n).css(this.css.suggestions)),
                          (e = l.map(o, function(t) {
                            var e,
                              n = p.suggestion
                                .replace('%PREFIX%', i.cssClasses.prefix)
                                .replace(
                                  '%SUGGESTION%',
      ...
      function(t, e, n) {
        'use strict'
        t.exports = { hits: n(67), popularIn: n(68) }
      },
      function(t, e, n) {
        'use strict'
        var i = n(0),
        ...
        var u = (function() {
          function r() {
            ...
            !(function(t, e) {
              ...
              Array.isArray(e) &&
                2 === e.length &&
                (this.defaultPosition = e.join(',')),
              (this.placesOptions = n),
              (this.placesAutocomplete = Object(i.default)(this.placesOptions)),
              (this.query = ''),
            ...
            (e = [
                ...
                value: function() {
                  ...
                  return (
                    this.defaultPosition &&
                      ((t.insideBoundingBox = void 0),
                      (t.aroundLatLngViaIP = !1),
                      (t.aroundLatLng = this.defaultPosition)),
                    t
                  )
                },
              },
              {
                ...
                value: function(t) {
                  var s = this,
                    a = t.helper
                  null === this.initialLatLngViaIP &&
                    (this.initialLatLngViaIP = a.getQueryParameter(
                      'aroundLatLngViaIP',
                    )),
                    this.placesAutocomplete.on('change', function(t) {
                      var e = t.suggestion,
                        n = e.latlng,
                        r = n.lat,
                        i = n.lng,
                    ...
                    this.placesAutocomplete.on('clear', function() {
                      ;(s.query = ''),
                        a.setQueryParameter('insideBoundingBox'),
                        s.defaultPosition
                          ? a
                              .setQueryParameter('aroundLatLngViaIP', !1)
                              .setQueryParameter(
              ...
              },
              {
                ...
                value: function(t, e) {
                  ...
                  return (
                    (this.query = i),
                    (this.initialLatLngViaIP = t.getQueryParameter(
                      'aroundLatLngViaIP',
                    )),
                    this.placesAutocomplete.setVal(i || ''),
                    this.placesAutocomplete.close(),
                    t
                      .setQueryParameter('insideBoundingBox')
                      .setQueryParameter('aroundLatLngViaIP', !1)
                      .setQueryParameter('aroundLatLng', o)
                  )
                },
              },
              {
                ...
                value: function(t, e) {
                  ...
                  if (
                    t.places &&
                    this.query === t.places.query &&
                    n.aroundLatLng === t.places.position
                  )
                    return t
                  if (void 0 !== n.aroundLatLng || this.query)
                    return o({}, t, {
                      places: { query: this.query, position: n.aroundLatLng },
                    })
                  var r = o({}, t)
                  return delete r.places, r
                },
              },
            ]) && c(t.prototype, e),
            n && c(t, n),
