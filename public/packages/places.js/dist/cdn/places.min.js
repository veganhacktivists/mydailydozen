            ...
            source: (function(t) {
              ...
              function R(r, t) {
                ...
                return (
                  T && (e.aroundLatLng = T),
                  j
                    .search(L.computeQueryParams(e))
                    .then(function(n) {
                      var t = n.hits.map(function(t, e) {
                        return Object(
                          N.a,
                        )({ formatInputValue: L.formatInputValue, hit: t, hitIndex: e, query: r, rawAnswer: n })
                      })
                      return L.onHits({ hits: t, query: r, rawAnswer: n }), t
                    })
                    .then(t)
                    .catch(function(t) {
                      403 !== t.statusCode ||
                ...
                (R.configure = function(t) {
                  ...
                  ;(I = e.params),
                    (L = e.controls).useDeviceLocation && null === k
                      ...
                      : L.useDeviceLocation ||
                        null === k ||
                        (navigator.geolocation.clearWatch(k), (T = k = null))
                }),
                R
              )
      ...
      function(t, e, n) {
        ...
        function k(t) {
          ...
          if (e instanceof NodeList) {
            ...
            return k(I({}, t, { container: e[0] }))
          }
          if ('string' == typeof e) {
            var s = document.querySelectorAll(e)
            return k(I({}, t, { container: s }))
          }
              ...
              I({}, t, {
                ...
                onRateLimitReached: function() {
                  0 !== a.listenerCount('limit')
                    ? a.emit('limit', { message: C.rateLimitReached })
                    : console.log(C.rateLimitReached)
                },
                onInvalidCredentials: function() {
                  t && t.appId && t.appId.startsWith('pl')
                    ? console.error(C.invalidCredentials)
                    : console.error(C.invalidAppId)
                },
                container: void 0,
              }),
            ),
            ...
            (function(l) {
              ...
              (r = (function() {
                ...
                return (
                  ...
                  (E.init = function(t, e) {
                    ...
                    if ('string' == typeof t)
                      if ('<' == (t = t.trim())[0] && g.test(t))
                        (n = E.fragment(t, RegExp.$1, e)), (t = null)
                      else {
                      ...
                      if (P(t))
                        ...
                        (n = E.fragment(t.trim(), RegExp.$1, e)), (t = null)
                      else {
                        if (e !== c) return u(e).find(t)
                        n = E.qsa(p, t)
                      }
                  ...
                  (u.fn = {
                    ...
                    concat: function() {
                      ...
                      for (t = 0; t < arguments.length; t++)
                        (e = arguments[t]), (n[t] = E.isZ(e) ? e.toArray() : e)
                    ...
                    closest: function(n, r) {
                      ...
                      return (
                        this.each(function(t, e) {
                          for (
                            ;
                            e && !(o ? 0 <= o.indexOf(e) : E.matches(e, n));
                  ...
                  (E.Z.prototype = z.prototype = u.fn),
                  (E.uniq = n),
                  (E.deserializeValue = J),
                  (u.zepto = E),
                  u
                )
              })()),
