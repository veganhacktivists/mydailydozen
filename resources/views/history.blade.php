  ...
  <div class="mt-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <x-history-calendar :history="$history"></x-history-calendar>
		...
		<br>
		<h2 class="text-lg leading-6 font-medium text-cool-gray-900 mb-6">Head over to your <a href="{{route('settings')}}" class="text-blue-500 hover:underline">settings page</a> to add or remove groups!</h2>
