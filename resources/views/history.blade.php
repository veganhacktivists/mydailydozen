            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-pine-600">
                ...
                <div class="mt-5 overflow-y-auto">
                    <nav class="px-2 space-y-1">
                        <a href="/home" class="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white bg-pine-100 focus:outline-none focus:bg-pine-500 transition ease-in-out duration-150">
                            <!-- Heroicon name: home -->
                        ...
                        <a href="/history" class="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-pine-700 hover:text-white hover:bg-pine-500 focus:outline-none focus:bg-pine-500 transition ease-in-out duration-150">
                            <!-- Heroicon name: clock -->
                            <svg class="mr-4 h-6 w-6 text-pine-200 transition ease-in-out duration-150" fill="none" viewBox="0 0 24 24" stroke="currentColor">
